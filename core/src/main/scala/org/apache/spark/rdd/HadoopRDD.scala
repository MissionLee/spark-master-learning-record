...
class HadoopRDD[K, V](
  ...
  protected def getInputFormat(conf: JobConf): InputFormat[K, V] = {
    // scalastyle:off
    println("HadoopRDD.getInputFormat")
    // scalastyle:on
  ...
  override def getPartitions: Array[Partition] = {
    // scalastyle:off
    println("HadoopRDD.getParitions")
    // scalastyle:on
    ...
    try {
      ...
      // scalastyle:off
      println("HadoopRDD.getParitions : Array[Paritions].length "+array.length)
      // scalastyle:on
      array
    } catch {
